<html lang="en">
  <head>
    ...
    <title>@lang('email.email_transaction_failed.title')</title>
  </head>
  <body>
        ...
        <td>
          <span
            style="
              ...
              margin-left: 300px;
            "
            >@lang('email.email_transaction_failed.hashtag')</span
          >
        </td>
      </tr>
    </table>
      ...
      <tr>
        <td style="height: 208px; background: #fff3eb; border-radius: 8px">
          ...
          <h1
            ...
            "
          >
            @lang('email.email_transaction_failed.lines.first')
          </h1>
        </td>
      </tr>
    </table>
      ...
      <tr>
        ...
        >
          <p
            ...
            "
          >
              @lang('email.email_transaction_failed.lines.second')
          </p>
          <p
            style="
              text-align: center;
            ...
            "
          >
            <strong> @lang('email.email_transaction_failed.lines.third')</strong>
          </p>
          <p
            style="
              text-align: center;
            ...
            "
          >
              @lang('email.email_transaction_failed.lines.fourth', [
                    'child_quantity' => $data->child_quantity,
                    'month_price' => $data->amount . ',00',
                    'revelation_price' => $data->revelation_amount . ',00',
                    'total_price' => $data->total_price . ',00'
              ])
          </p>
            <a href="http://sls-landing-page-chosen-prod.s3-website.us-east-1.amazonaws.com/chage-payment">
          <button
            style="
              font-family: Roboto;
              font-style: normal;
            ...
            "
          >
              @lang('email.email_transaction_failed.lines.fifth')
          </button></a>
          <section style="margin-top: 40px">
            <p
              ...
              "
            >
                @lang('email.email_transaction_failed.lines.sixth')
            </p>
            <p
              style="
                text-align: center;
              ...
              "
            >
                @lang('email.email_transaction_failed.lines.seventh')
            </p>
          </section>
        </td>
      </tr>
