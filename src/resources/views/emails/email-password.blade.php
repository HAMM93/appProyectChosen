<html lang="en">
  <head>
    ...
    <title>@lang('email.email_password.title')</title>
  </head>
        ...
        <td>
          <span
            style="
              ...
              margin-left: 300px;
            "
            >@lang('email.email_password.hashtag')</span
          >
        </td>
      </tr>
    </table>
      ...
      <tr>
        <td style="height: 208px; background: #fff3eb; border-radius: 8px">
          ...
          <h1
            ...
            "
          >
            @lang('email.email_password.lines.first')
          </h1>
        </td>
      </tr>
    </table>
    <table width="582px" align="center">
      <tr>
        <td
          ...
          "
        >
          @lang('email.email_password.lines.second')
        <a href="@lang('email.email_password.button_link', ['token' => $token])">
          <button
            style="
              font-family: Roboto;
              font-style: normal;
            ...
            "
          >
            @lang('email.email_password.lines.third')
          </button>
        </a>
          <section style="margin-top: 40px">
            <p
              ...
              "
            >
              @lang('email.email_password.lines.fourth')
            </p>
          </section>
        </td>
      </tr>
